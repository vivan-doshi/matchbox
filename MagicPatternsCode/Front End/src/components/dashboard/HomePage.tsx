        ...
        <div className="flex items-center gap-3 w-full">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-cardinal focus:border-cardinal outline-none transition-all"
              value={searchTerm}
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-4 pr-10 py-3 rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-cardinal focus:border-cardinal outline-none transition-all cursor-pointer text-sm font-medium text-slate-700 hover:bg-slate-50"
